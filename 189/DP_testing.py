...
def kp_R(p=0, m=0, n=0, items=[], c=0, incomp_classes=[], _file="problem1.in"):
    ...
    for u in range(100):
        ...
        for i in range(len(ps)):
            ...
            if val > best_value:
                best_weight, best_cost, best_value, knapsack = _weight, _cost, val, ps[i]
...
# st = time.clock()
# s, k = kp_R(_file="problem4.in")
# ed = time.clock()
# print("time = ", ed-st)

# params = get_params("problem3.in")
# d = make_dict(params[4], params[5])
# for i in range(100000):
#     sample = random.sample(params[4], 16)
